...
function makeExcel(finalExcel){
    ...
    workbook.write("../results/PrimaryResults_141participants.xlsx");
}
...
// makeJsonFromXlsx(); // Converts XLSX files From data/2_preprocessed_data folder to seperate JSON files into data/3_json_files folder. Sould run before makeFinalExcelFromJsons function.
makeFinalExcelFromJsons(); // Converts JSON files form  data/3_json_files folder into single Excel file (PrimaryResults_141participants.xlsx). This shouldnt run without having JSON files in data folder.
